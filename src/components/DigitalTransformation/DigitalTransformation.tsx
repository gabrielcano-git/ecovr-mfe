...
const tabContents: TabContent[] = [
  {
    icon: (
        ...
        <g id="Group 8396">
            <path id="Vector" d="M22.75 0.236328H19.25V7.87245H22.75V0.236328Z"
                fill="#02D72F" />
            <path id="Vector_2"
            ...
            <path id="Vector_3"
                ...
                fill="#02D72F" />
            <path id="Vector_4" d="M7.63612 19.4863H0V22.9863H7.63612V19.4863Z"
                fill="#02D72F" />
            <path id="Vector_5"
            ...
            <path id="Vector_6"
                ...
                fill="#02D72F" />
            <path id="Vector_7" d="M22.75 34.6002H19.25V42.2363H22.75V34.6002Z"
                fill="#02D72F" />
            <path id="Vector_8"
  ...
  },
  {
    icon: (
        ...
        <g id="Group 640">
            <g id="Group">
                <path id="Vector" d="M40 39.9605H0V0.236328H4.16331V35.7972H40V39.9605Z"
                    fill="#02D72F" />
                <path id="Vector_2"
    ...
    icon: (
        ...
        <defs>
            <clipPath id="clip0_46_745">
                <rect width="36.0353" height="44" fill="white"
...
const DigitalTransformation: React.FC = () => {
  ...
  return (
    <div className={styles["digital-transformation"]}>
      <SectionTitle>
        Sua empresa tem um problema?
        <br />
        <u>A VR tem a solução</u>
      </SectionTitle>

      <Tabs
        className={styles["digital-transformation__content"]}
        selectedIndex={selectedTab}
        onSelect={(index) => setSelectedTab(index)}
      >
        <TabList className={styles["digital-transformation__problems"]}>
          {tabContents.map((tab, index) => (
            <Tab
              key={index}
              className={`${styles["digital-transformation__problem-item"]} ${
                selectedTab === index
                  ? styles["digital-transformation__problem-item--active"]
                  : ""
              }`}
            >
        ...
        <div>
          {tabContents.map((tab, index) => (
            <TabPanel
              key={index}
              className={`${styles["digital-transformation__solution"]} ${
                selectedTab === index
                  ? styles["digital-transformation__solution--active"]
                  : ""
              }`}
            >
